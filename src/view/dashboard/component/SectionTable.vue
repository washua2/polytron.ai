  ...
  0: [
    {
      ...
      cameras: [
        ...
        { name: "B004-192.168.128.54", status: "online" },
        { name: "B005-192.168.128.55", status: "online" },
        { name: "B006-192.168.128.56", status: "online" },
        { name: "B007-192.168.128.57", status: "online" },
        { name: "B008-192.168.128.58", status: "online" },
        { name: "B009-192.168.128.59", status: "online" },
      ]
    },
    // {
    //   title: "Wellness",
  ...
  1: [
    {
      ...
      visitDuration: 30,
      cameras: [
        { name: "B010-192.168.128.60", status: "warning" },
        { name: "B011-192.168.128.61", status: "online" },
        { name: "B012-192.168.128.62", status: "online" },
        { name: "B013-192.168.128.63", status: "online" },
        { name: "B014-192.168.128.64", status: "online" },
        { name: "B015-192.168.128.65", status: "online" },
      ]
    }
  ],
  2: [
    {
      ...
      visitDuration: 22,
      cameras: [
        { name: "B016-192.168.128.66", status: "online" },
        { name: "B017-192.168.128.67", status: "online" },
        { name: "B018-192.168.128.68", status: "online" },
        { name: "B019-192.168.128.69", status: "online" },
        { name: "B020-192.168.128.70", status: "online" },
        { name: "B021-192.168.128.71", status: "online" },
        { name: "B022-192.168.128.72", status: "online" },
        { name: "B023-192.168.128.73", status: "online" },
        { name: "B024-192.168.128.74", status: "online" },
        { name: "B025-192.168.128.75", status: "online" },
      ]
    }
  ]
}
